...
curl -i -H "Authorization: token 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" -d '{"name": "git-bash", "auto_init": true, "private": true, "gitignore_template": "nanoc"}' https://api.github.com/user/repo
